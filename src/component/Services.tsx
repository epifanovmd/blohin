        ...
        <div className="card-deck">
          ...
          <div className="card text-center">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Главное преимущество этого водозабора заключается в том, что его
                можно пробурить без использования тяжелой техники, потому что
                грунтовые воды находятся на небольшой глубине в районе 12-16
                метров.
              </p>
            </div>
          </div>
